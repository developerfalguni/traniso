 ...
 *  running at all times and eliminating wasted CPU cycles from busy waiting. This result is a fater and more efficient
...
class Zebra_cURL {
     ...
     *  @return void
     */
    function __construct($htmlentities = false)
    {
