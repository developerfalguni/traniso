...
<tr>
	<td width="25%"><span class="box_label">Job No</span><br /><?php echo $job_order['id2_format']; ?></td>
	<td width="25%"><span class="box_label">Date</span><br /><?php echo $job_order['date']; ?></td>
	<td colspan="2"><span class="box_label">Party</span><br /><?php echo $party ?></td>
</tr>

<tr>
	<td colspan="4"><span class="box_label">Remarks</span><br /><?php echo $job_order['remarks'] ?></td>
</tr>
</table>
...
<?php
	$i = 1;
	foreach ($job_order_details as $r) {
		echo '<tr>
