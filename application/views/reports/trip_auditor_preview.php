...
foreach ($rows as $r) {
	...
	<td class="tiny">' . $r['transporter_bill_no'] . '</td>
	<td class="tiny">' . $r['transporter_bill_date'] . '</td>
...
<tfoot>
<tr>
	<th class="alignright tiny" colspan="12">Total</th>
	<th class="alignright tiny"><?php echo inr_format($total['party_rate']) ?></th>
	<th colspan="3"></th>
	<th class="alignright tiny"><?php echo inr_format($total['transporter_rate']) ?></th>
	<th colspan="2"></th>
	<th class="alignright tiny"><?php echo inr_format($total['self_adv']) ?></th>
	<th class="alignright tiny"><?php echo inr_format($total['party_adv']) ?></th>
	<th></th>
	<th class="alignright tiny"><?php echo inr_format($total['pump_adv']) ?></th>
	<th class="alignright tiny"><?php echo inr_format($total['allowance']) ?></th>
	<th class="alignright tiny"><?php echo inr_format(round($total['balance'], 0)) ?></th>
</tr>
</tfoot>
</table>
