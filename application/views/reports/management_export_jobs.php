	...
	<td class="nowrap">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="btn-group">
				<?php 
				echo //anchor($this->_clspath.$this->_class."/preview", 'Preview', 'class="btn btn-default Preview Popup"') .
					//anchor($this->_clspath.$this->_class."/preview/1", 'PDF', 'class="btn btn-default Preview Popup"') .
