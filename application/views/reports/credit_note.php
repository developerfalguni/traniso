...
<tr>
	<td rowspan="2" colspan="2"><span class="box_label">To</span><br />
		<?php echo (isset($voucher['credit_party_name']) ? $voucher['credit_party_name'] : ''); ?><br />
		<?php if (isset($voucher['credit_party_address'])) 
			  	echo $voucher['credit_party_address']; ?></td>
...
<tr>
	<td colspan="2"><span class="box_label">Shipper</span><br />
		<?php echo (strlen($shipper['name']) == 0 ? $job['vi_shipper_name'] : $shipper['name']) ?></td>
