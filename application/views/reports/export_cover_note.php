...
<tr>
	<td colspan="2"><span class="box_label">Vessel</span><br /><span class="big bold"><?php echo $export_details['vessel_name'] ?></span></td>
</tr>
...
<tr>
	<td colspan="2"><span class="box_label">Description</span><br /><span class="big bold"><?php echo $product['name'] ?></span></td>
</tr>

<tr>
	<td width="50%"><span class="box_label">Invoice No</span><br /><span class="big"><?php echo $job['invoice_no'] . ' / ' . $job['invoice_date'] ?></span></td>
	<td width="50%"><span class="box_label">C.I.F. Rs.</span><br /><span class="big"><br /></span></td>
</tr>

<tr>
	<td width="50%"><span class="box_label">Accessible Value Rs.</span><br /><span class="big"><br /></span></td>
	<td width="50%"><span class="box_label">Duty Rs.</span><br /><span class="big"></span></td>
</tr>
...
<tr>
	...
	<td width="50%"><span class="box_label">W.H.B. No &amp; Date</span><br /><span class="big"></span></td>
</tr>
