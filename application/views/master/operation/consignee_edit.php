...
<div class="card card-default">
	<div class="card-header">
		...
		<div class="card-tools w-50">
			<div class="form-group mb-0 row">
				<label class="col-md-3 col-form-label col-form-label-sm">Select Consignee : </label>
				<div class="col-sm-9">
					<?php echo form_dropdown('consigneeList', [], '', 'class="form-control mb-0" id="consigneeSelect2" '); ?>
				</div>
			</div>
		</div>
	</div>
	<div class="card-body">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<?php echo form_dropdown('country_id', $this->kaabar->getCountries(), '', 'class="form-control form-control-sm" id="country_id"'); ?>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label">Email Id</label>
					<input type="text" class="form-control form-control-sm" name="email_id" value="" id="email_id">
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<textarea class="form-control form-control-sm" rows="1" name="address4" id="address4"></textarea> 
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label">Cargo Details</label>
					<textarea class="form-control form-control-sm" rows="1" name="cargo_details" id="cargo_details"></textarea> 
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="float-right pt-2">
					<button type="button" class="btn btn-success" id="Add" onclick="updateConsignee('0')"><i class="fa fa-plus"></i> Add</button>
...
<script type="text/javascript" language="JavaScript">
	...
	$(document).ready(function() {
		...
		$('#consigneeSelect2').select2({
			ajax: { 
				url: '<?php echo site_url($this->_clspath.$this->_class) ?>/consigneeList/',
				type: "GET",
				dataType: 'json',
				delay: 250,
				beforeSend: function(){
	    	...
	    	updateConsignee(consignee_id);
	    });
	});

	function updateConsignee(id = null)
    {   
    	if(id){
        	$.ajax({
                url: '<?php echo base_url($this->_clspath.$this->_class) ?>/getConsignee/'+id,
                type: 'post',
                dataType: 'json',
                beforeSend: function(){
		            $("#loader").show();
                ...
                success:function(response) {
                	...
                	else
                	{
	            		...
	            		$("#email_id").val(response.row.email_id);
	            		$("#adress4").val(response.row.address4);
	            		...
	            		$("#cargo_details").val(response.row.cargo_details);
