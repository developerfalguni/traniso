			...
			<div class="col-md-12" id="">
				<div class="card card-default">
					<div class="card-header text-center">
						<h3 class="bold mb-0">Invoice for <?php echo $type ?> - Forex Billing</h3>
					</div>
						        ...
						        if(item.id > 0) {
						        	...
						        	my_html += '<tr>';
										...
										my_html += '<td class="align-middle">';
											...
											my_html += '<input type="hidden" class="Unchanged CurrencyNameId" value="'+item.currency_id+'" title="id" name="currency['+item.id+']">';
										my_html += '</td>';
										my_html += '<td class="align-middle">';
						        ...
						        if(item.id > 0) {
						        	...
						        	my_html += '<tr>';
										...
										my_html += '<td class="align-middle">';
											...
											my_html += '<input type="hidden" class="Unchanged CurrencyNameId" value="'+item.sell_currency_id+'" title="id" name="kbr_currency['+item.id+']">';
										my_html += '</td>';
